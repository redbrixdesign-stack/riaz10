...
const STATIC_ASSETS = [
  ...
  'js/services/ai.min.js?v=11','js/services/notification.min.js?v=9','js/services/message-scheduler.min.js?v=9','js/services/export.min.js?v=11','js/services/weather.min.js?v=3','js/services/tasks.min.js?v=1','js/services/job-field-service.min.js?v=1','js/services/capacity.min.js?v=1','js/services/communications.min.js?v=2',
  'js/features/companion/companion.min.js?v=28','js/features/onboarding/onboarding.min.js?v=7','js/features/today/today.min.js?v=19','js/features/today/home-screen-controller.min.js?v=12','js/features/appointments/appointments.min.js?v=41','js/features/customer/customer.min.js?v=12','js/features/route/route.min.js?v=16',
