...
const STATIC_ASSETS = [
  './','index.html','css/core.css','css/components.css?v=18',
  ...
  'js/features/companion/companion.min.js?v=2','js/features/onboarding/onboarding.min.js?v=6','js/features/today/today.min.js?v=17','js/features/today/home-screen-controller.min.js?v=10','js/features/appointments/appointments.min.js?v=23','js/features/customer/customer.min.js?v=3','js/features/route/route.min.js?v=9',
