...
const STATIC_ASSETS = [
  './','index.html','css/core.css?v=22','css/components.css?v=20','assets/fonts/material-symbols-rounded.woff2',
  ...
  'js/features/companion/companion.min.js?v=3','js/features/onboarding/onboarding.min.js?v=6','js/features/today/today.min.js?v=17','js/features/today/home-screen-controller.min.js?v=10','js/features/appointments/appointments.min.js?v=23','js/features/customer/customer.min.js?v=3','js/features/route/route.min.js?v=9',
