const CACHE_NAME = 'advisoros-v6-38';
const FONT_CACHE_NAME = 'advisoros-fonts-1';
const STATIC_ASSETS = [
  './','index.html','css/core.css?v=23','css/components.css?v=27','assets/fonts/material-symbols-rounded.woff2',
  'js/vendor/dexie.min.js?v=1','js/vendor/minidexie.min.js?v=12',
  'js/core/config.min.js?v=10','js/core/utils.min.js?v=6','js/core/db.min.js?v=16','js/core/geoprovider.min.js?v=1','js/core/geo.min.js?v=6','js/core/search.min.js?v=3','js/core/tax.min.js?v=2','js/core/app.min.js?v=9','js/core/contact.min.js?v=3',
