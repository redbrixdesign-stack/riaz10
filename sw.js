const CACHE_NAME = 'advisoros-v6-4';
...
const STATIC_ASSETS = [
  ...
  'js/services/ai.min.js?v=2','js/services/notification.min.js?v=4','js/services/export.min.js?v=2','js/services/weather.min.js?v=2',
