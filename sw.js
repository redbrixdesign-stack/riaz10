const CACHE_NAME = 'advisoros-v6-17';
...
const STATIC_ASSETS = [
  ...
  'js/features/onboarding/onboarding.min.js?v=6','js/features/today/today.min.js?v=17','js/features/today/home-screen-controller.min.js?v=10','js/features/appointments/appointments.min.js?v=23','js/features/customer/customer.min.js?v=3','js/features/route/route.min.js?v=9',
  'js/features/followups/followups.min.js?v=3','js/features/orders/orders.min.js?v=5',
  'js/features/money/money.min.js?v=6','js/features/talk/talk.min.js?v=12','js/features/measure/measure.min.js?v=6',
