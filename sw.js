const CACHE_NAME = 'advisoros-v6-27';
...
const STATIC_ASSETS = [
  ...
  'js/services/ai.min.js?v=7','js/services/notification.min.js?v=6','js/services/message-scheduler.min.js?v=3','js/services/export.min.js?v=3','js/services/weather.min.js?v=3',
  'js/features/companion/companion.min.js?v=2','js/features/onboarding/onboarding.min.js?v=6','js/features/today/today.min.js?v=17','js/features/today/home-screen-controller.min.js?v=11','js/features/appointments/appointments.min.js?v=27','js/features/customer/customer.min.js?v=4','js/features/route/route.min.js?v=10',
  'js/features/followups/followups.min.js?v=5','js/features/orders/orders.min.js?v=5',
  'js/features/money/money.min.js?v=7','js/features/talk/talk.min.js?v=14','js/features/measure/measure.min.js?v=6',
  'js/features/ocr/ocr.min.js?v=17','js/features/control/control.min.js?v=5','js/features/settings/settings.min.js?v=11'
];
