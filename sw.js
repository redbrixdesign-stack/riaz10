const CACHE_NAME = 'advisoros-v6-94';
const STATIC_ASSETS = [
  './','index.html','manifest.json?v=3','css/core.css?v=34','css/components.css?v=47',
  ...
  'js/core/config.min.js?v=14','js/core/utils.min.js?v=7','js/core/db.min.js?v=29','js/core/geoprovider.min.js?v=1','js/core/geo.min.js?v=11','js/core/search.min.js?v=3','js/core/tax.min.js?v=2','js/core/install-prompt.min.js?v=1','js/core/app.min.js?v=34','js/core/legal.min.js?v=1','js/core/contact.min.js?v=4',
  ...
  'js/features/companion/companion.min.js?v=22','js/features/onboarding/onboarding.min.js?v=7','js/features/today/today.min.js?v=18','js/features/today/home-screen-controller.min.js?v=12','js/features/appointments/appointments.min.js?v=39','js/features/quotes/quotes.min.js?v=1','js/features/jobs/jobs.min.js?v=3','js/features/invoices/invoices.min.js?v=1','js/features/suppliers/suppliers.min.js?v=2','js/features/capacity/capacity.min.js?v=1','js/features/profitability/profitability.min.js?v=1','js/features/retention/retention.min.js?v=1','js/features/customer/customer.min.js?v=10','js/features/route/route.min.js?v=13',
  ...
  'js/features/ocr/ocr.min.js?v=22','js/features/control/control.min.js?v=13','js/features/settings/settings.min.js?v=20'
];
