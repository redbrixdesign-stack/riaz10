const CACHE_NAME = 'advisoros-v6-22';
...
const STATIC_ASSETS = [
  ...
  'js/services/ai.min.js?v=4','js/services/notification.min.js?v=6','js/services/message-scheduler.min.js?v=2','js/services/export.min.js?v=3','js/services/weather.min.js?v=3',
