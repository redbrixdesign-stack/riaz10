...
const CACHE_NAME = 'advisoros-v6-100';
const STATIC_ASSETS = [
  ...
  'js/core/config.min.js?v=15','js/core/utils.min.js?v=7','js/core/db.min.js?v=29','js/core/geoprovider.min.js?v=1','js/core/geo.min.js?v=11','js/core/search.min.js?v=3','js/core/tax.min.js?v=2','js/core/install-prompt.min.js?v=1','js/core/app.min.js?v=36','js/core/lazy-features.min.js?v=1','js/core/legal.min.js?v=2','js/core/contact.min.js?v=4',
  ...
  'js/features/companion/companion.min.js?v=24','js/features/onboarding/onboarding.min.js?v=7','js/features/today/today.min.js?v=18','js/features/today/home-screen-controller.min.js?v=12','js/features/appointments/appointments.min.js?v=40','js/features/customer/customer.min.js?v=10','js/features/route/route.min.js?v=14',
