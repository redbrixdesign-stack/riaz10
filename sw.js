...
const CACHE_NAME = 'advisoros-v6-107';
const STATIC_ASSETS = [
  ...
  'js/features/companion/companion.min.js?v=26','js/features/onboarding/onboarding.min.js?v=7','js/features/today/today.min.js?v=18','js/features/today/home-screen-controller.min.js?v=12','js/features/appointments/appointments.min.js?v=41','js/features/customer/customer.min.js?v=11','js/features/route/route.min.js?v=15',
