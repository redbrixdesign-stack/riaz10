const CACHE_NAME = 'advisoros-v6-18';
...
const STATIC_ASSETS = [
  ...
  'js/features/onboarding/onboarding.min.js?v=6','js/features/today/today.min.js?v=17','js/features/today/home-screen-controller.min.js?v=10','js/features/appointments/appointments.min.js?v=24','js/features/customer/customer.min.js?v=3','js/features/route/route.min.js?v=9',
