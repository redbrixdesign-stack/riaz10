const CACHE_NAME = 'advisoros-v6-23';
...
const STATIC_ASSETS = [
  ...
  'js/services/ai.min.js?v=5','js/services/notification.min.js?v=6','js/services/message-scheduler.min.js?v=2','js/services/export.min.js?v=3','js/services/weather.min.js?v=3',
  ...
  'js/features/money/money.min.js?v=7','js/features/talk/talk.min.js?v=13','js/features/measure/measure.min.js?v=6',
