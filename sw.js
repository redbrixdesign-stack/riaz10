...
const CACHE_NAME = 'advisoros-v6-108';
const STATIC_ASSETS = [
  ...
  'js/core/config.min.js?v=15','js/core/utils.min.js?v=7','js/core/db.min.js?v=32','js/core/geoprovider.min.js?v=1','js/core/geo.min.js?v=15','js/core/search.min.js?v=3','js/core/tax.min.js?v=2','js/core/install-prompt.min.js?v=1','js/services/voice-notes.min.js?v=1','js/core/app.min.js?v=38','js/core/lazy-features.min.js?v=2','js/core/legal.min.js?v=2','js/core/contact.min.js?v=4',
  'js/services/ai.min.js?v=11','js/services/notification.min.js?v=8','js/services/message-scheduler.min.js?v=7','js/services/export.min.js?v=11','js/services/weather.min.js?v=3','js/services/tasks.min.js?v=1','js/services/job-field-service.min.js?v=1','js/services/capacity.min.js?v=1','js/services/communications.min.js?v=1',
  'js/features/companion/companion.min.js?v=27','js/features/onboarding/onboarding.min.js?v=7','js/features/today/today.min.js?v=18','js/features/today/home-screen-controller.min.js?v=12','js/features/appointments/appointments.min.js?v=41','js/features/customer/customer.min.js?v=11','js/features/route/route.min.js?v=16',
  'js/features/leads/leads.min.js?v=1','js/features/followups/followups.min.js?v=18','js/features/orders/orders.min.js?v=15',
  'js/features/money/money.min.js?v=10','js/features/talk/talk.min.js?v=21','js/features/measure/measure.min.js?v=8',
  'js/features/ocr/ocr.min.js?v=22','js/features/control/control.min.js?v=14'
];
