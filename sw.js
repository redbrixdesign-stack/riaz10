const CACHE_NAME = 'advisoros-v6-40';
...
const STATIC_ASSETS = [
  ...
  'js/features/followups/followups.min.js?v=7','js/features/orders/orders.min.js?v=5',
  'js/features/money/money.min.js?v=7','js/features/talk/talk.min.js?v=16','js/features/measure/measure.min.js?v=6',
