...
const STATIC_ASSETS = [
  ...
  'js/services/ai.min.js?v=9','js/services/notification.min.js?v=7','js/services/message-scheduler.min.js?v=4','js/services/export.min.js?v=9','js/services/weather.min.js?v=3','js/services/tasks.min.js?v=1','js/services/quote-document.min.js?v=1','js/services/job-field-service.min.js?v=1','js/services/finance-document.min.js?v=1','js/services/capacity.min.js?v=1','js/services/communications.min.js?v=1',
