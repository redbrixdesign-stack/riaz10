...
const CACHE_NAME = 'advisoros-v6-111';
const STATIC_ASSETS = [
  ...
  'js/features/ocr/ocr.min.js?v=24','js/features/control/control.min.js?v=13','js/features/settings/settings.min.js?v=19'
];
