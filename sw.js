const CACHE_NAME = 'advisoros-v6-7';
...
const STATIC_ASSETS = [
  ...
  'js/core/config.min.js?v=9','js/core/utils.min.js?v=5','js/core/db.min.js?v=14','js/core/geo.min.js?v=5','js/core/search.min.js?v=2','js/core/tax.min.js?v=2','js/core/app.min.js?v=5','js/core/contact.min.js?v=3',
  ...
  'js/features/onboarding/onboarding.min.js?v=3','js/features/today/today.min.js?v=15','js/features/today/home-screen-controller.min.js?v=5','js/features/appointments/appointments.min.js?v=18','js/features/route/route.min.js?v=6',
  'js/features/money/money.min.js?v=3','js/features/talk/talk.min.js?v=7','js/features/measure/measure.min.js?v=2',
  'js/features/ocr/ocr.min.js?v=10','js/features/control/control.min.js?v=3','js/features/settings/settings.min.js?v=8'
];
