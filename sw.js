const CACHE_NAME = 'advisoros-v6-46';
const STATIC_ASSETS = [
  ...
  'js/core/config.min.js?v=10','js/core/utils.min.js?v=6','js/core/db.min.js?v=16','js/core/geoprovider.min.js?v=1','js/core/geo.min.js?v=7','js/core/search.min.js?v=3','js/core/tax.min.js?v=2','js/core/install-prompt.min.js?v=1','js/core/app.min.js?v=16','js/core/legal.min.js?v=1','js/core/contact.min.js?v=4',
