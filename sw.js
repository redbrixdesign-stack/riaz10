const CACHE_NAME = 'advisoros-v6-8';
const FONT_CACHE_NAME = 'advisoros-fonts-1';
const STATIC_ASSETS = [
  './','index.html','css/core.css','css/components.css?v=12',
  ...
  'js/features/ocr/ocr.min.js?v=11','js/features/control/control.min.js?v=3','js/features/settings/settings.min.js?v=8'
];
