...
const CACHE_NAME = 'advisoros-v6-109';
const STATIC_ASSETS = [
  ...
  'js/core/config.min.js?v=15','js/core/utils.min.js?v=7','js/core/db.min.js?v=33','js/core/geoprovider.min.js?v=1','js/core/geo.min.js?v=15','js/core/search.min.js?v=3','js/core/tax.min.js?v=2','js/core/install-prompt.min.js?v=1','js/services/voice-notes.min.js?v=1','js/core/app.min.js?v=38','js/core/lazy-features.min.js?v=3','js/core/legal.min.js?v=2','js/core/contact.min.js?v=4',
  'js/services/ai.min.js?v=11','js/services/notification.min.js?v=8','js/services/message-scheduler.min.js?v=8','js/services/export.min.js?v=11','js/services/weather.min.js?v=3','js/services/tasks.min.js?v=1','js/services/job-field-service.min.js?v=1','js/services/capacity.min.js?v=1','js/services/communications.min.js?v=2',
  ...
  'js/features/money/money.min.js?v=10','js/features/talk/talk.min.js?v=22','js/features/measure/measure.min.js?v=8',
