...
const CACHE_NAME = 'advisoros-v6-101';
const STATIC_ASSETS = [
  ...
  'js/core/config.min.js?v=15','js/core/utils.min.js?v=7','js/core/db.min.js?v=29','js/core/geoprovider.min.js?v=1','js/core/geo.min.js?v=12','js/core/search.min.js?v=3','js/core/tax.min.js?v=2','js/core/install-prompt.min.js?v=1','js/core/app.min.js?v=36','js/core/lazy-features.min.js?v=1','js/core/legal.min.js?v=2','js/core/contact.min.js?v=4',
