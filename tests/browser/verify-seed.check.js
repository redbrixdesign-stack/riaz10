...
(async () => {
  ...
  try {
    ...
    ok('Home feed: RIGHT NOW → TODAY → ATTENTION → WEEK → ASK BEELO order', JSON.stringify(home.labels) === JSON.stringify(['RIGHT NOW', 'TODAY', 'NEEDS YOUR ATTENTION', 'THIS WEEK', 'ASK BEELO']), home.labels);
