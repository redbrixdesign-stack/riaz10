...
| Backup format 1 / database schema 8 | Validate and restore all thirty-eight tables, including retention, consent history, communication events, integration provenance, conflicts, and offline outbox | Both-engine Phase 6 lifecycle and restore tests |
