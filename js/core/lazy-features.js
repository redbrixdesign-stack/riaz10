...
[
  ...
  { id: 'social', name: 'Create Social Post', icon: 'campaign', scripts: ['js/features/social/social.min.js?v=1'] },
  { id: 'settings', name: 'Settings', icon: 'settings', scripts: ['js/features/settings/settings.min.js?v=23'] }
