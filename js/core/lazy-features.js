/* Secondary workflows are registered as lightweight route proxies. Their
...
[
  { id: 'quotes', name: 'Quotes', icon: 'request_quote', scripts: ['js/services/quote-document.min.js?v=1', 'js/features/quotes/quotes.min.js?v=1'] },
  { id: 'jobs', name: 'Jobs', icon: 'construction', scripts: ['js/features/jobs/jobs.min.js?v=3'] },
  { id: 'invoices', name: 'Invoices', icon: 'receipt_long', scripts: ['js/services/finance-document.min.js?v=1', 'js/features/invoices/invoices.min.js?v=1'] },
