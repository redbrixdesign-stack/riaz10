    ...
    const content = `
      ...
      <div class="sheet-body kanban-sheet-body">
        ...
        <div class="kanban-btn-grid">
          ...
          <button class="btn btn-outline btn-sm" data-close="1" data-action="App.navigate" data-args='${JSON.stringify(['suppliers', { orderId: order.id }])}'><span class="material-symbols-rounded">local_shipping</span>Supplier orders</button>
