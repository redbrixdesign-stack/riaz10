...
const HomeScreenController = {
  ...
  async renderDynamicHomeScreen(containerId) {
    ...
    try {
      // Home was rebuilt around a weekly-calendar-and-visit-list layout
      // (see renderWeeklyHomeScreen below), replacing the four-state
      // Morning Blueprint / Mid-Day / Evening Closeout / Tomorrow Preview
      // machine as the primary view. That state machine is kept intact
      // further down this file rather than deleted - buildHomeScreenHtml,
      // renderMorningBlueprint, renderMidDayDashboard etc. all still work
      // standalone if this needs reverting, they're just not the entry
      // point any more.
